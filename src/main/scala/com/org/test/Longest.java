...
class Longest{
    ...
    */
    ...
    static int funPall(String str){
        int prodMax=-1;
        int resArr[][]=longestPalindromicSubsequence(str);
        for(int i=0;i<str.length()-1;i++){
            int tmpProd=resArr[0][i]*resArr[i+1][str.length()-1];
            if(prodMax<=tmpProd){
                prodMax=tmpProd;
            }
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(l.funPall("axbawbaseksqke"));
