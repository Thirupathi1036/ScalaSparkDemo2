...
object EmpDeptDF extends App {
  ...
  val empFile = "C:\\Users\\thirupathi.c\\IdeaProjects\\ScalaSparkDemoDemo\\input\\emp.txt"
  val deptFile = "C:\\Users\\thirupathi.c\\IdeaProjects\\ScalaSparkDemo\\input\\dept.txt"
  ...
  val deptDS: DataFrame = deptRdd.toDF()
  ...
  val empDeptDf = empDS.join(deptDS, Seq("deptId"), "left")
  ...
  val maxSalByDept = empDeptDf.
    withColumn("row_num", dense_rank().over(secondMaxSal)).distinct()
